package com.step5;
//데이터 처리하기 - 클래스 설계(VO(Value Object)패턴, DTO(Data Transfer Object)패턴)
//변수의 선언 목적은? - 기억해줘 - 하나만 아니고 여러 개를 한 번에 기억해줘 - 여러 개가 관계가 있다
//여러 개의 변수를 선언하고 있는 DeptVO를 설계하였다 - 한 번에 한 개 로우만 담을 수 있다. - 여러 개의 로우는 못 담는다. - 객체배열이면 가능함
...
class DeptVO{
	...
	public int getDeptno() {
		return deptno; //캡슐화로 인해서 직접 접근이 불가능함
	}
...
//		}
//		System.out.println(dVOs[0]); //null
//		System.out.println(dVOs[1]); //null
//		System.out.println(dVOs[2]); //null
