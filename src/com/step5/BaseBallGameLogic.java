...
public class BaseBallGameLogic {
		//현재는 null이므로 NullPointException 발동하겠지만
		//이 문제를 생성자를 통해 해결함
		BaseBallGameUI baseBallGameUI = null; //위변조 하지 않고 원본을 가져오기 위해 new 사용 안하는 것임.
		int my[]  = new int[3];
		int com[] = new int[3]; //컴퓨터가 채번한 숫자 담기
		//단 이와 같은 방법을 사용할 때 순환구조에 빠지지 않도록 주의할 것. - 제어역행
